...
export class CreateAsbBipekNonStdReview1764337043412 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_asb_bipek_non_std_reviews_komponen_bangunan" ON "asb_bipek_non_std_reviews" ("id_asb_komponen_bangunan")`);
        ...
        await queryRunner.query(`
            ALTER TABLE "asb_bipek_non_std_reviews"
            ADD CONSTRAINT "fk_asb_bipek_non_std_reviews_komponen_bangunan"
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // Drop foreign keys
        await queryRunner.query(`ALTER TABLE "asb_bipek_non_std_reviews" DROP CONSTRAINT IF EXISTS "fk_asb_bipek_non_std_reviews_komponen_bangunan"`);
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_asb_bipek_non_std_reviews_komponen_bangunan"`);
